...
docker run -d -p 3000:3000 <image_name>  # run image in detach mode
docker image prune    # remove all dangling images (rebuild without new tag)
...
![k8s-clusters](assets/k8s-clusters.svg)
